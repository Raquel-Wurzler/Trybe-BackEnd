...
import Book from '../interfaces/book.interface'; // na pasta interface é onde estão criados os types (tipos) que serão usados nessa aplicação. Elas podem ser do tipo interface ou types
